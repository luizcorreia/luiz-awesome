...
function _M.get()
  local globalkeys = gears.table.join(
    ...
    awful.key({modkey}, 'p', function() awful.util.spawn_with_shell(screenshot) end,
              {description = 'Take a screenshot of your active monitor and copy it to clipboard', group = 'screenshots (clipboard)' }),
    awful.key({altkey, 'Shift'}, 'p', function() awful.util.spawn_with_shell(region_screenshot) end,
