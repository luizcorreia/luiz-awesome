...
local config_path = awful.util.getdir("config") .. "statusbar/luiz/"
...
-- I.clock = wibox.widget.imagebox(theme.widget_clock)
-- W.textclock = awful.widget.watch("date +'%a %d %b %R'", 60, function(widget, stdout)
